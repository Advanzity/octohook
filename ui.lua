...
function library:Init()
		...
		if self.open then
			if input.UserInputType.Name == "MouseMovement" then
				if self.cursor then
					...
					self.cursor.PointB = MousePos + Vector2.new(16,5);
					self.cursor.PointC = MousePos + Vector2.new(5,16);
	...
	local index; index = hookmetamethod(game,'__index', newcclosure(function(t, i)
		if checkcaller() then
			return index(t, i)
		end
	...
	local newindex; newindex = hookmetamethod(game,'__index', newcclosure(function(t, i, v)
		if checkcaller() then
